...
const AuthScreen = () => {
	...
	return (
		<div
			...
			style={{ backgroundImage: `url('/staf.png')` }}
		>
			{/* Navbar */}
			...
			<div className='flex flex-col items-center justify-center text-center py-40 text-white max-w-6xl mx-auto'>
				<h1 className='text-4xl md:text-5xl font-extrabold mb-6 leading-snug tracking-wide'>Stream.Binge.Repeat.</h1>
				...
				<form className='flex flex-col md:flex-row gap-4 w-1/2' onSubmit={handleFormSubmit}>
					<input
						...
						className='p-2 rounded flex-1 bg-white text-purple-500 border border-gray-700'
						value={email}
						onChange={(e) => setEmail(e.target.value)}
					/>
					<button className='bg-purple-700 text-xl lg:text-2xl px-2 lg:px-6 py-1 md:py-2 rounded flex justify-center items-center'>
						Get Started
			...
			{/* 1st Section */}
			<div className="py-10 text-white bg-gradient-to-r from-[#e1bee7] via-[#d38cd1] to-[#6b21a8]" >
			...
			{/* 2nd Section */}
			<div className='py-10 bg-gradient-to-r from-[#e1bee7] via-[#d38cd1] to-[#6b21a8] text-white'>
